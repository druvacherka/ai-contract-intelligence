...
export default function Login() {
  ...
  const { login, loginWithGoogle, loginAsDemo, isAuthenticated, isLoading: authLoading, authError } = useAuth()
      ...
      <div className="w-full max-w-md">
        ...
        <div className="auth-card border rounded-2xl p-8">
          ...
          <div className="space-y-3">
            <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 py-3 rounded-xl font-semibold transition hover:shadow-md cursor-pointer">
          ...
          <div className="mt-4">
            <button 
              ...
              className="w-full text-center btn-explore border py-3 rounded-xl font-semibold transition cursor-pointer block"
            >
              🚀 Explore Dashboard (Demo Mode)
            </button>
          </div>
